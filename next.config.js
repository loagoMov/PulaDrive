...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "rbsaqrcrkkeqqikidwnr.supabase.co",
        pathname: "/**",
      },
    ],
  },
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              `script-src 'self' 'unsafe-inline' 'unsafe-eval' ${process.env.NODE_ENV !== "production" ? "http://localhost:* " : ""}https://*.clerk.com https://*.clerk.accounts.dev https://*.clerk.dev https://clerk.puladrive.com https://challenges.cloudflare.com https://us.i.posthog.com https://us-assets.i.posthog.com`,
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: blob: https://*.convex.cloud https://img.clerk.com https://images.clerk.dev https://rbsaqrcrkkeqqikidwnr.supabase.co https://us.i.posthog.com https://us-assets.i.posthog.com",
              ...
              `connect-src 'self' ${process.env.NODE_ENV !== "production" ? "http://localhost:* ws://localhost:* http://127.0.0.1:*" : ""} https://*.convex.cloud wss://*.convex.cloud https://*.clerk.com https://*.clerk.accounts.dev https://*.clerk.dev https://clerk.puladrive.com https://clerk-telemetry.com https://pumped-egret-156334.upstash.io https://rbsaqrcrkkeqqikidwnr.supabase.co https://us.i.posthog.com https://us-assets.i.posthog.com`,
